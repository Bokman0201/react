...
//                                이름 :  <input name="itemName" className="form-control"
//                                 value={data.itemName} onChange={changeData} />
//                            가격 :  <input name="itemPrice" className="form-control"
//                                 value={data.itemPrice} onChange={changeData} />
//                            분류 :  <input name="itemType" className="form-control"
...
//             {/* Modal */}
//             <div className="modal fade" ref={bsModal} id="exampleModal" data-bs-backdrop="static" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
//                 <div className="modal-dialog" role="document">
//                     <div className="modal-content">
//                         <div className="modal-header">
//                             <h5 className="modal-title" id="exampleModalLabel">신규상품 등록</h5>
...
//                             {/* 수동으로 닫는 버튼 */}
//                             <button type="button" onClick={cancelAddItem} className="btn btn-secondary">취소</button>
//                             <button type="button" className="btn btn-primary"
